<template>
  <li class="nav-cart" @mouseover="shwoCarHandle" @mouseout="hideCarHandle">
        ...
        <div class="full" v-else>
          ...
          <div class="nav-cart-total">
            ...
            <h5>
              合计：
              <span class="price-icon">¥</span>
              <span class="price-num ng-binding" ng-bind="cartMenu.totalPrice">{{totle}}</span>
            </h5>
            <h6>
              <!-- <a
    ...
    <transition name="ball" v-on:before-enter="beforeEnter"
...
<style>
  .ball-enter-active{
    transition: .5s cubic-bezier(.17,.67,.66,1.52);
  }
