  ...
  <div id="main">
    <div class="content page-order-payment">
      ...
      <div class="confirm-detail">
        ...
        <p class="info-detail">详细地址：
            {{orderInfo.receiveInfo.province}}{{orderInfo.receiveInfo.city}}
            {{orderInfo.receiveInfo.county}}
        </p>
      </div>
      <div class="confirm-detail">
      ...
      <div class="confirm-goods-table">
        ...
        v-for="item,index in orderInfo.goodsData">
